...
public class MapBackground : MonoBehaviour
{
    ...
    void OnMouseDrag()
    {
        ...
        if(MapManager.Inst.mapCamera) MapManager.Inst.mapCamera.transform.position = new Vector3(newCamPos.x, newCamPos.y, MapManager.Inst.mapCamera.transform.position.z);
    }
}
